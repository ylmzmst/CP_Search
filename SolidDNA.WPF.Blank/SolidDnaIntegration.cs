...
namespace SolidDNA.WPF.Blank
{
    ...
    [Guid("1EE8C988-C04B-4715-A4CB-6AF47710F752"), ComVisible(true)]  // Replace the GUID with your own.

    public class CPSearchIntegration : SolidAddIn
    {
        /// <summary>
    ...
    public class MySolidDnaPlugIn : SolidPlugIn<MySolidDnaPlugIn>
    {
        ...
        /// </summary>
        private TaskpaneIntegration<MyTaskpaneUI, CPSearchIntegration> mTaskpane;
        ...
        /// My Add-in title
        /// </summary>
        public override string AddInTitle => "CP Search";

        /// <summary>
        /// My Add-in description
        /// </summary>
        public override string AddInDescription => "Tool for Searching Custom Property for All Configurations";
        ...
        public override void ConnectedToSolidWorks()
        {
            ...
            mTaskpane = new TaskpaneIntegration<MyTaskpaneUI, CPSearchIntegration>
            {
                ...
                IconPathFormat = Path.Combine(this.AssemblyPath(), "Assets\\search{0}.png"),
